#首先生成初始节点，利用虚拟力的方法对节点的检测方向进行更新，然后利用蒙特卡洛的方法增加新节点，直到满足所需的最低覆盖概率
import random
import math
...
def monte_carlo():
    ...
    while True:
        ...
        if calculate_probability(x,y) > 0.98:
            count += 1
        else:
...
if __name__ == '__main__':
    ...
    df.to_excel('保存路径，请自己修改', sheet_name='sensor', index=False, header=True)